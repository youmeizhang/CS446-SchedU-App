...
public class ReadJsonFile
{
    ...
    private class accessFile extends AsyncTask<Course, Void, Void> {
    ...
    public void readFromWeb (Course course){    //(String courseName, String courseNumber){

        new accessFile().execute(course);
    }
